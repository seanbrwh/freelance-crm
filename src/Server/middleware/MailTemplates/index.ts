    ...
    <head>
     ...
     .force-full-width {
      ...
      <style type="text/css" media="screen">
          @media screen {
             /*Thanks Outlook 2013! ${link}goo.gl/XLxpyl*/
            td, h1, h2, h3 {
                ...
                <td align="center" valign="top">
                    ...
                    <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="100%" bgcolor="#4dbfbf">
                      ...
                      <tr>
                        <td>
                          <div><!--[if mso]>
                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${link}" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="8%" stroke="f" fillcolor="#178f8f">
                              <w:anchorlock/>
                              <center>
                            <![endif]-->
                                <a href="${link}"
